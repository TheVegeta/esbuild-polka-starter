...
// node_modules/@polka/parse/index.js
var require_parse = __commonJS({
  "node_modules/@polka/parse/index.js"(exports) {
    exports.json = function(opts = {}) {
      const limit = opts.limit || 100 * 1024;
      ...
      return function(req, res, next) {
        ...
        if (isNaN(clength) && head["transfer-encoding"] == null)
          return next();
        if (ctype && !ctype.includes(type))
          return next();
        if (clength === 0)
          return next();
        let bits = [];
...
var require_every = __commonJS({
  "node_modules/@arr/every/index.js"(exports, module2) {
    module2.exports = function(arr, cb) {
...
var require_matchit = __commonJS({
  "node_modules/matchit/lib/matchit.js"(exports) {
    "use strict";
...
var require_trouter = __commonJS({
  "node_modules/trouter/index.js"(exports, module2) {
    ...
    module2.exports = Trouter;
  }
});

// node_modules/@polka/url/index.js
var require_url = __commonJS({
  "node_modules/@polka/url/index.js"(exports, module2) {
...
var require_polka = __commonJS({
  "node_modules/polka/index.js"(exports, module2) {
    var http = require("http");
    var Router2 = require_trouter();
    ...
    var Polka = class extends Router2 {
      constructor(opts = {}) {
        super(opts);
        this.apps = {};
        this.wares = [];
    ...
    module2.exports = (opts) => new Polka(opts);
  }
});
...
var import_polka = __toESM(require_polka());
var handleJson = (req, res, next) => {
  res.json = (data) => {
    res.setHeader("content-type", "application/json");
    res.end((0, import_fast_json_stable_stringify.default)(data));
  };
  next();
};
var handleErr = (req, res, err) => {
  res.statusCode = 500;
...
var Router = import_polka.default;
...
var import_polka2 = __toESM(require_polka());
var app = (0, import_polka2.default)();
var port = parseInt(process.env.PORT || 8080);
app.use((0, import_cors.default)());
app.use((0, import_parse.json)());
app.use(handleJson);
